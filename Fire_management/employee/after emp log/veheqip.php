...
<body background-image="flat2.jpg"> 
    <div class="header">
        ...
        <div class="phpfile">
            ...
            $sql = "select * from veh_eqip";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
            // output data of each row
            echo "<table><tr><th>Station Number</th><th>Vehicle Name</th> <th>Name of Eqipment</th><th>Type of Equipment</th></tr>";
            while($row = $result->fetch_assoc())
            {
            echo "<tr><td>" . $row["S_num"]. "</td><td>" . $row["vname"]    . "</td><td>". $row["Name"]. "</td><td>" .$row["Type"] . "</td> </tr>";
            }
            echo "</table>";
            } 
            else 
