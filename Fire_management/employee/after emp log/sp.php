...
if(!$conn)
{
    ...
    echo "<table><tr><th>Station Number</th><th>Station Name</th><th>Station Address</th><th>Phone</th></tr>";
    while($row = $result->fetch_assoc())
     {
    echo "<tr><td>" . $row["S_num"]. "</td><td>" . $row["SName"]    . "</td><td>". $row["Address"]. "</td><td>" .$row["Phone"] . "</t</tr>";
    }
    echo "</table>";
    } 
    else 
