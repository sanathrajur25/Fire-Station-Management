...
.inlist a{
    ...
    <body> 
        <div class="header" >
            ...
            <ul class="lists">
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/deleteemp.php">EMPLOYEE</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/deleteeqip.php">EQUIPMENT</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/deleteveh.php">VEHICLE</a> </li>
