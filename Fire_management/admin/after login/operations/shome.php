...
.inlist a{
    ...
    <body> 
        <div class="header" >
            ...
            <ul class="lists">
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/showemp.php">EMPLOYEE</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/showeqip.php">EQUIPMENT</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/showveh.php">VEHICLE</a> </li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/showeme.php">EMERGENCY</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/employee/after%20emp%20log/sp.php">STATION</a></li>
            </ul>   
        </div>
