...
.inlist a{
    ...
    <body> 
        <div class="header" >
            ...
            <ul class="lists">
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/insertemp.php">EMPLOYEE</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/insertequip.php">EQUIPMENT</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/insertveh.php">VEHICLE</a> </li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/inserteme.php">EMERGENCY</a></li>
                <li  class="inlist"><a href="http://localhost:8080/Fire_management/admin/after%20login/operations/insertstat.php">STATION</a></li>
            </ul>   
        </div>
