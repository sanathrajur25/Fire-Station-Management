...
<div class="leftside">
        <form action="insertvalues.php" method="post">
            ...
            <Label>
                ...
                <span>Station Name</span> <br> <input type="text" name="SName" class="inp"><br><br>
                <span>Address</span> <br> <input type="text" name="Address" class="inp"><br><br>
                <span>Phone</span> <br> <input type="text" name="Phone" class="inp"><br><br>
                <button name="addstat" class="but">INSERT</button>
            </Label>
            </center>
        </form>
    </div>
