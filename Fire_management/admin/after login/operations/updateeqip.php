...
<body>
    ...
    <div class="leftside">
        <form action="seldel.php" method="post">
            <center>
            <Label>
                <span>Equipment id</span><input type="text" name="E_no" class="inp"><br><br>
                <span>new Last serviced</span><input type="text" name="last_service" class="inp"><br><br>
                <span>new next serviced</span><input type="text" name="next_service" class="inp"><br><br>
                <button name="upeqip" class="but">Update</button>
            </Label>
            </center>
