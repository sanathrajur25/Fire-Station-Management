...
<div class="leftside">
        ...
        <center>
            <Label>
                <span>Vehicle ID :</span><br><input type="text" name="vid" class="inp"><br><br>
                <span>Vehicle Type :</span><br><input type="text" name="vtype" class="inp"><br><br>
                <span>Vehicle Name :</span> <br> <input type="text" name="vname" class="inp"><br><br>
                <span>Vehicle Purchase Year :</span> <br> <input type="text" name="vpurchase" class="inp"><br><br>
                <span>Station Number :</span> <br> <input type="text" name="S_num" class="inp"><br><br>
                
                <button name="addveh"class="but">INSERT</button>
            </Label>
        </center>
        </form>
    </div>
